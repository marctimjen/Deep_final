...
torch.save(model.state_dict(), "C:/Users/Marc/Desktop/Billeder/params/final/network.pt")
run[f"network/network_weights"].upload(File("C:/Users/Marc/Desktop/Billeder/params/final/network.pt"))
